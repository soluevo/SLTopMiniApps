...
class TopBarGridList: UIView {
    ...
    let selectedColor = UIColor().hexStringToUIColor(hex: ConfigManager.instance.companySelected?.theme?.toolbarHex ?? "") 
    ...
    lazy var btnList: UIButton = {
        ...
        view.setImage(getImage(named: "list").getInColor(selectedColor), for: .normal)
        return view
    }()
    ...
    lazy var btnGrid: UIButton = {
        ...
        view.setImage(getImage(named: "grid").getInColor(unSelectedColor), for: .normal)
        return view
    }()
    ...
    lazy var btnFilter: UIButton = {
        ...
        view.setAttributedTitle(NSAttributedString(string: "A-Z", attributes: [
            NSAttributedString.Key.font : UIFont.avenirHeavy(12),
    ...
    @objc func selectList(){
        btnList.setImage(getImage(named: "list").getInColor(selectedColor), for: .normal)
        btnGrid.setImage(getImage(named: "grid").getInColor(unSelectedColor), for: .normal)
        self.delegate?.changeToList()
    }
    
    @objc func selectGrid(){
        btnGrid.setImage(getImage(named: "grid").getInColor(selectedColor), for: .normal)
        btnList.setImage(getImage(named: "list").getInColor(unSelectedColor), for: .normal)
