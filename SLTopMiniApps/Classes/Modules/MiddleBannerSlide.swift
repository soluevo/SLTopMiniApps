...
class SLMiddleBannerSlide: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate {
    ...
    init(images: [UIImage], delegate: UIViewController? = nil) {
...
//        collectionView.reloadData()
        self.delegate?.selected(obj: self)
    }
    ...
    func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
      targetContentOffset.pointee = scrollView.contentOffset
        ...
        self.collection.scrollToItem(at:indexPath, at: UICollectionView.ScrollPosition.centeredHorizontally, animated: true)
    }
}
