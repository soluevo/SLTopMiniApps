...
class ProductGrid: UIView {
    ...
    init(imageUrl: String? = nil, image: UIImage? = nil, title: String, price: String, priceDetail: String, rate: Double? = 0, delegate: UIViewController? = nil) {
    ...
    private func loadSubViews(){
        ...
        stars.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -20).isActive = true
